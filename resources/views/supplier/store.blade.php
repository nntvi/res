                                ...
                                <form role="form" action="{{route('supplier.p_store')}}" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" size="40" class="form-control" name="code" maxlength="30">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" size="40" class="form-control" name="name" maxlength="60">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input type="email" size="40" class="form-control" name="email" maxlength="100">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                                <div class="form-group">
                                                        ...
                                                        <input type="text" size="40" class="form-control" name="phone" id="Account_phone" maxlength="30">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6">
                                                <div class="form-group">
                                                        <label>Địa chỉ</label>
                                                        <input type="text" size="40" class="form-control" name="address" maxlength="150">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                                <div class="form-group">
                                                        ...
                                                        <input type="text" size="40" class="form-control" name="mst" maxlength="100">
